...
/**
 * Classe abstraite servant de structures pour les différentes requetes sur la base de données
 * Les différents accés aux tables vont hériter de cette classe
 */
public abstract class AbstractBDD {

    // Nous sommes à la premi�re version de la base
