...
/*
    ...
    /*
        ...
        /*String query = "SELECT *"+
                " FROM "
                + maBaseSQLite_.TABLE_USERS + " u JOIN "
                + maBaseSQLite_.TABLE_GROUPE + " g USING (" + maBaseSQLite_.COL_USER_ID +")"; //+ " g ON " + "u." + maBaseSQLite_.COL_ID +" = " + "g." + maBaseSQLite_.COL_USER_ID +";" ;
*/
        String query = "SELECT "
                + maBaseSQLite_.COL_GROUP_NAME + ","
       ...
       /* String query = "SELECT "
                ...
                + maBaseSQLite_.COL_PRENOM +
                " FROM "
                + maBaseSQLite_.TABLE_USERS + " INNER JOIN "
                + maBaseSQLite_.TABLE_GROUPE + " ON " + maBaseSQLite_.TABLE_USERS + "." + maBaseSQLite_.COL_ID
                +" = " + maBaseSQLite_.TABLE_GROUPE +"." + maBaseSQLite_.COL_USER_ID +" WHERE " + maBaseSQLite_.TABLE_GROUPE
                + "." + maBaseSQLite_.COL_GROUP_NAME + " = ? ";// +" ;" ;*/
